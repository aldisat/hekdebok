![[../attachments/Pasted image 20250115091538.png]]
# 1. Nmap
## TCP
![[../attachments/Pasted image 20250115091904.png]]
![[../attachments/Pasted image 20250115092513.png]]
tidak ada port UDP

# 2. Port 80 - monitorsthree.htb
- Login http://monitorsthree.htb/login.php -> cek ==SQLinjection== -> **NOPE**
![[../attachments/Pasted image 20250115093436.png]]
- Forgot password http://monitorsthree.htb/forgot_password.php
- Input `admin` -> bisa dikirim forgot password
![[../attachments/Pasted image 20250115100130.png]]
- Input `admin'` -> error SQL maria DB , input `admin--+` error hilang
![[../attachments/Pasted image 20250115100613.png]]
- Whatweb sales@monitorsthree.htb
![[../attachments/Pasted image 20250115092553.png]]
...
![[../attachments/Pasted image 20250115101959.png]]
cacti -> 302
tambahkan cacti.monitorsthree.htb ke /etc/host
![[../attachments/Pasted image 20250115141920.png]]
...
![[../attachments/Pasted image 20250115102652.png]]
- Database db name
![[../attachments/Pasted image 20250115111205.png]]
eh ternya tidak boleh pake SQLmap :(
## Pake manual
- ditemukan db memiliki ==9 kolom==
![[../attachments/Pasted image 20250115132027.png]]
![[../attachments/Pasted image 20250115132109.png]]
...
final result -> users 
```
![[../attachments/Pasted image 20250115211940.png]]
## Pake ffuf (alternative best way)
Cek panjang db -> ==16==
![[../attachments/Pasted image 20250118093103.png]]

Bruteforce nama db -> ==monitorsthree_db==
![[../attachments/Pasted image 20250118093927.png]]

Bruteforce nama table -> ==users== menarik
![[../attachments/Pasted image 20250118092840.png]]
Brute force nama kolom -> ada ==username== dan password
![[../attachments/Pasted image 20250118102638.png]]

Brute force data pada kolom username -> ==admin==
![[../attachments/Pasted image 20250118103608.png]]

Cek panjang kata password dari username admin -> 32
![[../attachments/Pasted image 20250118104015.png]]

Brute force huruf per huruf password dari username admin -> `31a181c8372e3afc59dab863430610e8`
![[../attachments/Pasted image 20250118132202.png]]

decode md5 string tsb  => ==greencacti2001==
![[../attachments/Pasted image 20250118132758.png]]

# 5. Login admin ke dashboard cacti
berhasil login
![[../attachments/Pasted image 20250118132937.png]]
ada CVE https://github.com/Safarchand/CVE-2024-25641 untuk mendapatkan RCE
![[../attachments/Pasted image 20250118134134.png]]
dapat shell tapi, tidak bisa mengakses /home
![[../attachments/Pasted image 20250118134627.png]]
untuk masuk /home harus melalui user marcun dan root
data netstat
![[../attachments/Pasted image 20250118134853.png]]
/include/config.php
![[../attachments/Pasted image 20250118214859.png]]
login mysql -> ada tables ==user auth_user==
![[../attachments/Pasted image 20250119095751.png]]
Terdapat credential marcus -> $2y$10$Fq8wGXvlM3Le.5LIzmM9weFs9s6W2i1FLg3yrdNGmkIaxo79IBjtK
![[../attachments/Pasted image 20250119095915.png]]

detection hash, dan crack menggunaka hashcat
![[../attachments/Pasted image 20250119103259.png]]
...
![[../attachments/Pasted image 20250119104734.png]]
...
![[../attachments/Pasted image 20250119105314.png]]
menggunakan tiny server
![[../attachments/Pasted image 20250119110234.png]]
...
![[../attachments/Pasted image 20250119122931.png]]
![[../attachments/Pasted image 20250119123609.png]]
original
```
...
![[../attachments/Pasted image 20250119124650.png]]
```
...
```
berhasil login
![[../attachments/Pasted image 20250119150157.png]]

lakukan backup root.txt
![[../attachments/Pasted image 20250119154439.png]]
restore backupmya, untuk mendapatkan root flag
![[../attachments/Pasted image 20250119154504.png]]==PWN!==