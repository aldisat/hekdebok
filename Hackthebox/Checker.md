![](../attachments/Pasted%20image%2020250223103627.png)
...
| UDP | -          |
## A.  TCP Active Port 
![](../attachments/Pasted%20image%2020250223103808.png)
## B. UDP Active Port
No result.
## C.  Domain
![](../attachments/Pasted%20image%2020250223112458.png)
...
- Login
- Forgot Password
![](../attachments/Pasted%20image%2020250223104349.png)
Port 8080 
Fitur:
- Login, ada satu form unik dengan value 60
- menggunakan **Teampass** -> coba cek versi nya
![](../attachments/Pasted%20image%2020250223104646.png)
## B. Directory
ga bisa ada waf kedua web servernya
![](../attachments/Pasted%20image%2020250223111956.png)
ada rate limiting
![](../attachments/Pasted%20image%2020250223104841.png)
## C. checker.htb Forgot Password
reflected
![](../attachments/Pasted%20image%2020250223113128.png)
cannot be exploited yet
![](../attachments/Pasted%20image%2020250223122524.png)
coba test SQLi injection save it to file, and send it to sqlmap
![](../attachments/Pasted%20image%2020250223212122.png)
tidak berhasil
## D. Teampass
...
![](../attachments/Pasted%20image%2020250224142310.png)
```
if [ "$#" -lt 1 ]; then
...
dapat credential
![](../attachments/Pasted%20image%2020250224144238.png)
```
...
![](../attachments/Pasted%20image%2020250224150057.png)
![](../attachments/Pasted%20image%2020250224150212.png)
## E. Credential on teampass
bob@checker.htb mYSeCr3T_w1kI_P4sSw0rD
![](../attachments/Pasted%20image%2020250224153732.png)
bisa login![](../attachments/Pasted%20image%2020250224194525.png)
reader hiccup-publicly-genesis
![](../attachments/Pasted%20image%2020250224153936.png)
tidak bisa login
![](../attachments/Pasted%20image%2020250224154041.png)
## Analisa Checker.htb
1. Search
...
![](../attachments/Pasted%20image%2020250224211926.png)

ternyata Bookstack ada versinya juga hmmmmm
Bookstack v23.10.2
![](../attachments/Pasted%20image%2020250228093950.png)
...
![](../attachments/Pasted%20image%2020250228141853.png)

Coba ganti vpn ke US (Tips dari Forum)
masukkan kode otp dari situs ini
![](../attachments/Pasted%20image%2020250228142747.png)
Berhasil login ssh dan dapat
![](../attachments/Pasted%20image%2020250228142856.png)
# 3. Privilege Escalation
## a. local port
![](../attachments/Pasted%20image%2020250228143124.png)
## b. Hosts
ada local network 127.0.0.1
![](../attachments/Pasted%20image%2020250301062443.png)

## c. Credential
/opt/BookStack/bootstrap/cache/config.php -> tidak ada db sqlitenya
![](../attachments/Pasted%20image%2020250301065545.png)

## d. sudo -l
![](../attachments/Pasted%20image%2020250228143034.png)
check-leak.sh
![](../attachments/Pasted%20image%2020250228143453.png)
...
![](../attachments/Pasted%20image%2020250301151752.png)

Buka shell lain
![](../attachments/Pasted%20image%2020250301151630.png)
# 4. Post Exploitation
## a. User Flag
## b. Root Flag
