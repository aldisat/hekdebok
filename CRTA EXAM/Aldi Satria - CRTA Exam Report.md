...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502191706.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502200314.png)
# 2. Reconnaisance 
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502191823.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503072125.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503072154.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503072210.png)
# 3. Initial Access
## a. Apache Tomcat
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502194243.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502200105.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502200143.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502201531.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502201150.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502203000.png)
## b. Linux Shell
Once we had shell access, we checked the `/etc/passwd` file and found two interesting users: `prod-admin` and `msfadmin`.
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502203550.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502203805.png)
We tried to SSH into 172.16.25.2 using those credentials, but none of them worked.
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502205617.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502210731.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502210536.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502211042.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502212459.png)
nmap result for 10.10.10.2
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502213143.png)
nmap result for 10.10.10.3
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502213446.png)
nmap result for 10.10.10.4
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502213805.png)
nmap result for 10.10.10.5
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502214254.png)
## c. Network Pivoting
As the next step, we initiated **network pivoting** using **proxychains** to facilitate access to the internal network.
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502211841.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502211954.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502212151.png)
## d. 10.10.10.3
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502215940.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502221723.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502223520.png)
...
```
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502224006.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502224046.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502224725.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502230925.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502230944.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502231222.png)
```
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250502232758.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503003406.png)
```
...
```
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503011259.png)
...
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503014200.png)
...
```
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503014451.png)
...
```
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503015733.png)
run this command to know parentDC from the domain and try acces directory
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503021509.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503022013.png)
...
```
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503022043.png)
![](../Hackthebox/HTB%20(Medium)%20-%20TheFrizz/Pasted%20image%2020250503025443.png)
# 5. Conclussion
